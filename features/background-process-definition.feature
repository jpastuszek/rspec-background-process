Feature: Defining background process
	...
	Scenario: Defining process executable
		...
		Then test process instance log should not contain foo bar
		...
		Given fresh test2 process instance is running and ready
		Then test2 process instance log should contain foo bar
		Then test2 process instance log should not contain hello world
